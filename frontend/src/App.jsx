    ...
    <div className="container">
      <div className="hero-panel">
        ...
        <div className="glass-card">
          ...
          <p><strong>Overall Mood:</strong> Positive</p>
          <p><strong>Top Positive Topics:</strong> Quality, Battery</p>
          <p><strong>Top Negative Topics:</strong> Delivery, Customer Support</p>
          <p><strong>Recommendation:</strong> Improve delivery experience to reduce negative feedback.</p>
        </div>
      </div>
